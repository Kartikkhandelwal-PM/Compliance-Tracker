...
const ARCHETYPES: Archetype[] = [
  ...
  {
    key: "isd",
    label: "Input Service Distributor · GSTR-6",
    weight: 2,
    naming: "company",
    profile: (r, cat, state) => base({
      entityType: "Company",
      ...
      isDirector: true,
      isDinHolder: true,
      totalIncome: between(r, 15000000, 90000000),
      turnover: between(r, 50000000, 400000000),
      hasBusinessIncome: true,
      taxAuditApplicable: true,
      paymentNatures: ["Salary", "Rent"] as PaymentNature[],
      tdsPerQuarter: between(r, 150000, 900000),
      gstRegType: "ISD",
      gstStateCategory: cat,
      epfCovered: true,
      monthlyPayroll: between(r, 800000, 4000000),
      professionalTaxState: PT_STATES.has(state) ? state : undefined,
      discipline: 0.7 + r() * 0.25,
    }),
  },
  {
    key: "aop",
