...
export const DEFS: ComplianceDef[] = [
  ...
  },
  {
    ...
    frequency: "Monthly",
    dueRule: "13th of the following month",
    applicability: "Input Service Distributors, distributing ITC to their branches (s.39(4))",
    lateFee: { kind: "perDay", amount: 100, cap: 5000, note: "₹100/day (CGST+SGST combined), capped at ₹5,000." },
    clientFacing: true,
  },
  {
  ...
  },
  {
    ...
    applicability: "Filed returns still within the s.139(5) revision window",
  ...
  },
  {
    ...
    applicability: "Any client within the 48-month s.139(8A) window, filed or not",
